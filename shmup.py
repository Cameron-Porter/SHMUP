...
player_img = pygame.image.load(path.join(img_dir, "player_blue.png")).convert()
...
shoot_sound = pygame.mixer.Sound(path.join(snd_dir, 'Laser Shot.wav'))
...
pygame.mixer.music.load(path.join(snd_dir, 'Cyberpunk.mp3'))
